...
class UserLogin(Model):
    user_id = BaseType(default=lambda: ObjectId(), serialize_when_none=False)
    user_email = EmailType(required=True)
    user_signin_ip = StringType(required=True)
    user_signin_browser = StringType(required=True)
    user_signin_browser_version = StringType(required=True)
    user_signin_os = StringType(required=True)
    user_signin_os_version = StringType(required=True)
    user_signin_device = StringType(required=True)
    user_signin_device_model = StringType(required=True)
    user_signin_latitude = FloatType(required=True)
    user_signin_longitude = FloatType(required=True)
    user_signin_otp = StringType()
    user_signin_datetime = DateTimeType(required=True)